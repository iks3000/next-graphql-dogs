...
function ModalWindow({ name }) {
  ...
  return (
    <>
      ...
      >
        <Text size="sm" mb={16}>
          We will carefully review all the details and contact you as soon as
          possible. Please provide your contact information.
        </Text>
        <Box>
          <form onSubmit={form.onSubmit(handleSubmit, handleError)}>
            ...
            <Button
              ...
              mt="sm"
              onClick={close}
              disabled={!form.isValid("name") || !form.isValid("email")}
            >
              Submit
            </Button>
          </form>
